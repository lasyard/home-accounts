...
TEST_CASE("write_read_delete")
{
    ...
    auto file = new CryptoFile(fileName, "123", "ABC");
    file->create();
    std::string str("This is a test.");
    file->writeSection(sectionName, str);
    delete file;
    file = new CryptoFile(fileName, "123", "ABC");
    file->open();
...
TEST_CASE("change_pass")
{
    ...
    file->changePass("DEF");
    delete file;
    file = new CryptoFile(fileName, "DEF", "ABC");
    file->open();
...
TEST_CASE("operator==")
{
    auto file = new CryptoFile("abc", "123", "ABC");
    auto file1 = new CryptoFile("abc", "456", "DEF");
    CHECK(*file == *file1);
}
