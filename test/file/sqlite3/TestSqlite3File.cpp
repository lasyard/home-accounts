...
static const char *fileName = "sqlite3-file-test.dat";
...
TEST_CASE("write_read_delete")
{
    ...
    delete file;
    file = new Sqlite3File(fileName, "123", "ABC");
    file->open();
...
TEST_CASE("change_pass" * doctest::skip())
{
    ...
    file->changePass("DEF");
    delete file;
    file = new Sqlite3File(fileName, "DEF", "ABC");
    file->open();
...
TEST_CASE("operator==")
{
    auto file = new Sqlite3File("abc", "123", "ABC");
    auto file1 = new Sqlite3File("abc", "456", "DEF");
    CHECK(*file == *file1);
}
