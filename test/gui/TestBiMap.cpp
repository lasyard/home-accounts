...
TEST_CASE("BiMap basic operations")
{
    ...
    SUBCASE("set_kv and bidirectional lookup")
    {
        ...
        CHECK_EQ(old.first, nullptr);
        CHECK_EQ(old.second, nullptr);
        CHECK(bimap.has_k(1));
    ...
    SUBCASE("lookup non-existent key returns nullptr")
    {
        CHECK_EQ(bimap.k_v(999), nullptr);
    }

    SUBCASE("lookup non-existent value returns nullptr")
    {
        CHECK_EQ(bimap.v_k(999), nullptr);
    }
